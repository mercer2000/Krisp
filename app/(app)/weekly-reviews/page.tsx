 ...
 * (happens when the AI wraps the response in code fences and JSON.parse fails during generation).
 */
...
export default function WeeklyReviewsPage() {
  ...
  // If topic clusters are empty but synthesisReport contains JSON, re-parse it
  ...
  return (
    <div className="flex h-full flex-col bg-[var(--background)]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <section
          className={`flex-1 overflow-auto px-4 py-4 sm:px-6 sm:py-6 ${
